export class Tile {
  ...
  setValue(value) {
    ...
    this.tileElement.style.setProperty('--bg-lightness', `${bgLightness}%`) //вычисляем цвет плитки
    this.tileElement.style.setProperty('--text-lightness', `${bgLightness < 50 ? 90 : 10}%`) //вычисляем цвет текста
  }
